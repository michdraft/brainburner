...
create view getStatistic as (
	select USERS.USERNAME, EXERCISEAREA.AREANAME, STATISTIC.PERCENT, STATISTIC.LEARNDATE, USERS.ID as USERID
	from STATISTIC join USERS on STATISTIC.USERID = USERS.ID
	join EXERCISEAREA on STATISTIC.EXERCISEAREAID = EXERCISEAREA.ID
);