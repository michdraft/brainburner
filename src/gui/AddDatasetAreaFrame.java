...
public class AddDatasetAreaFrame extends Frame {
	...
	public AddDatasetAreaFrame(DBConnection connection, String areaname) {
		initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lbl_question1, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                                .addGap(10, 10, 10)
	...
	public boolean insertDataset() {
		...
		String sql_insert = "insert into pool(exerciseareaid, question, answer) " +
				    "values((select id from exercisearea where " +
				    "exercisearea.areaname = '" + this.areaname + "'), '" +
				    question + "', '" + answer + "')";
